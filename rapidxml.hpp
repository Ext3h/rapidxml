...
namespace rapidxml
{
    ...
    public:
        ...
        template<class Ch>
        inline parse_error(const char *what, Ch *where)
            : m_what(what)
            , m_where(where)
        {
        }
...
namespace rapidxml
{
    ...
    namespace internal
    {
        ...
        {
            return size1 == size2 && std::memcmp(p1, p2, size1) == 0;
        }
    }
    //! \endcond
    ...
    private:
        ...
        inline static constexpr char *align(char *ptr)
        {
    ...
    public:
        ...
        constexpr inline xml_base() noexcept
            : m_name(nullstr())
            , m_value(nullstr())
            , m_name_size(0)
            , m_value_size(0)
    ...
    protected:
        ...
        // Return empty string
        static constexpr Ch zero = Ch('\0');
        inline static constexpr const Ch *nullstr()
        {
            return &zero;
        }

        const Ch *m_name;                   // Name of node, or 0 if no name
        const Ch *m_value;                  // Value of node, or 0 if no value
        std::size_t m_name_size;            // Length of node name, or 0 of no name
        std::size_t m_value_size;           // Length of node value, or 0 if no value
    ...
    public:
        ...
        constexpr inline xml_attribute() noexcept :
            m_prev_attribute(0),
            m_next_attribute(0)
        {
        }
        ...
        inline xml_attribute<Ch> *previous_attribute(const Ch *name = 0, std::size_t name_size = 0) const
        {
            if (name)
            {
                if (name_size == 0)
        ...
        //! \param case_sensitive Should name comparison be case-sensitive; non case-sensitive comparison works properly only for ASCII characters
        //! \return Pointer to found attribute, or 0 if not found.
        inline xml_attribute<Ch> *next_attribute(const Ch *name = 0, std::size_t name_size = 0) const
        {
            if (name)
            {
                if (name_size == 0)
    ...
    public:
        ...
        constexpr inline xml_node(node_type type) noexcept
            : m_type(type)
            , m_first_node(0)
            , m_last_node(0)
            , m_first_attribute(0)
        ...
        inline xml_node<Ch> *first_node(const Ch *name = 0, std::size_t name_size = 0) const
        {
            if (name)
            {
                if (name_size == 0)
        ...
        //! \param case_sensitive Should name comparison be case-sensitive; non case-sensitive comparison works properly only for ASCII characters
        //! \return Pointer to found child, or 0 if not found.
        inline xml_node<Ch> *last_node(const Ch *name = 0, std::size_t name_size = 0) const
        {
        ...
        inline xml_node<Ch> *previous_sibling(const Ch *name = 0, std::size_t name_size = 0) const
        {
        ...
        //! \param case_sensitive Should name comparison be case-sensitive; non case-sensitive comparison works properly only for ASCII characters
        //! \return Pointer to found sibling, or 0 if not found.
        inline xml_node<Ch> *next_sibling(const Ch *name = 0, std::size_t name_size = 0) const
        {
            assert(this->m_parent);     // Cannot query for siblings if node has no parent
            if (name)
            {
        ...
        //! \param case_sensitive Should name comparison be case-sensitive; non case-sensitive comparison works properly only for ASCII characters
        //! \return Pointer to found attribute, or 0 if not found.
        inline xml_attribute<Ch> *first_attribute(const Ch *name = 0, std::size_t name_size = 0) const
        {
            if (name)
            {
                if (name_size == 0)
        ...
        //! \param case_sensitive Should name comparison be case-sensitive; non case-sensitive comparison works properly only for ASCII characters
        //! \return Pointer to found attribute, or 0 if not found.
        inline xml_attribute<Ch> *last_attribute(const Ch *name = 0, std::size_t name_size = 0) const
        {
            if (name)
            {
                if (name_size == 0)
        ...
        inline void remove_node(xml_node<Ch> *where)
        {
            ...
            else
            {
                ...
                where->m_parent = 0;
                where->m_prev_sibling = 0;
                where->m_next_sibling = 0;
            }
        }
    ...
    private:
        ...
        size_t m_count_node;                    // Number of child nodes
        xml_node<Ch> *m_first_node;             // Pointer to first child node, or 0 if none; always valid
        xml_node<Ch> *m_last_node;              // Pointer to last child node, or 0 if none; always valid
        xml_attribute<Ch> *m_first_attribute;   // Pointer to first attribute of node, or 0 if none; always valid
        xml_attribute<Ch> *m_last_attribute;    // Pointer to last attribute of node, or 0 if none; always valid
    ...
    private:
        ...
        {
            inline static constexpr unsigned char test(Ch ch)
            {
                return internal::lookup_whitespace[static_cast<unsigned char>(ch)];
            }
        };
        ...
        struct node_name_pred
        {
            inline static constexpr unsigned char test(Ch ch)
            {
                return internal::lookup_node_name[static_cast<unsigned char>(ch)];
            }
        };
        ...
        struct attribute_name_pred
        {
            inline static constexpr unsigned char test(Ch ch)
            {
                return internal::lookup_attribute_name[static_cast<unsigned char>(ch)];
            }
        };
        ...
        struct text_pred
        {
            inline static constexpr unsigned char test(Ch ch)
            {
                return internal::lookup_text[static_cast<unsigned char>(ch)];
            }
        };
        ...
        struct text_pure_no_ws_pred
        {
            inline static constexpr unsigned char test(Ch ch)
            {
                return internal::lookup_text_pure_no_ws[static_cast<unsigned char>(ch)];
            }
        };
        ...
        struct text_pure_with_ws_pred
        {
            inline static constexpr unsigned char test(Ch ch)
            {
                return internal::lookup_text_pure_with_ws[static_cast<unsigned char>(ch)];
            }
        };
        ...
        struct attribute_value_pred
        {
            inline static constexpr unsigned char test(Ch ch)
            {
                if constexpr (Quote == Ch('\''))
                    return internal::lookup_attribute_data_1[static_cast<unsigned char>(ch)];
                else if constexpr (Quote == Ch('\"'))
                    return internal::lookup_attribute_data_2[static_cast<unsigned char>(ch)];
        ...
        struct attribute_value_pure_pred
        {
            ...
            {
                if constexpr (Quote == Ch('\''))
                    return internal::lookup_attribute_data_1_pure[static_cast<unsigned char>(ch)];
                else if constexpr (Quote == Ch('\"'))
                    return internal::lookup_attribute_data_2_pure[static_cast<unsigned char>(ch)];
                else return 0;       // Should never be executed, to avoid warnings on Comeau
            }
        };
                        ...
                        if (src[0] == Ch('&'))
                        {
                            ...
                            case Ch('#'): 
                                if (src[2] == Ch('x'))
                                {
                                    ...
                                    while (1)
                                    {
                                        unsigned char digit = internal::lookup_digits[static_cast<unsigned char>(*src)];
                                        if (digit == 0xFF)
                                            break;
                                        code = code * 16 + digit;
                                        ++src;
        ...
        inline void parse_node_attributes(Ch *&text, xml_node<Ch> *node)
        {
            ...
            while (attribute_name_pred::test(*text))
            {
                ...
                Ch *value = text, *end;
                constexpr int AttFlags = Flags & ~parse_normalize_whitespace;   // No whitespace normalization in attributes
                if (quote == Ch('\''))
